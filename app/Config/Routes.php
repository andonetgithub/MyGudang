...
$routes->post('/login', 'Login::masuk', ['filter' => 'noauth']);
//$routes->get'/login', 'Login::masuk', ['filter' => 'noauth']);
...
$routes->post('/supply/getFilter', 'Suplai::getFilter', ['filter' => 'auth']);
...
$routes->post('/export/getFilter', 'Keluar::getFilter', ['filter' => 'auth']);
